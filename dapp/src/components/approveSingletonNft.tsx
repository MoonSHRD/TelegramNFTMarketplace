...
export default function ApproveSingleton(props:Props){
  ...
  async function approveSingleton(event:React.FormEvent) {
    ...
    const SingletonNFT_Contract:Contract = new ethers.Contract(addressContract, abi, signer)
   ...
   // let passport_fee_wei = ethers.utils.formatUnits(1000,"wei");
    ...
    SingletonNFT_Contract.approve(marketAddress,token_id)
  ...
  return (
    ...
    <FormControl>
      <FormLabel >Approve Telegram NFT to marketplace: </FormLabel>
      <div>
