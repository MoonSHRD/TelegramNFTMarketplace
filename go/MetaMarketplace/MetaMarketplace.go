...
// MetaMarketplaceBuyOffer is an auto generated low-level Go binding around an user-defined struct.
type MetaMarketplaceBuyOffer struct {
...
// GetBuyOffer is a free data retrieval call binding the contract method 0x0a3621ca.
//
// Solidity: function getBuyOffer(address nft_contract, uint256 token_id, uint8 currency) view returns((address,uint256,uint256) b_offer)
func (_MetaMarketplace *MetaMarketplaceCaller) GetBuyOffer(opts *bind.CallOpts, nft_contract common.Address, token_id *big.Int, currency uint8) (MetaMarketplaceBuyOffer, error) {
	var out []interface{}
	err := _MetaMarketplace.contract.Call(opts, &out, "getBuyOffer", nft_contract, token_id, currency)

	if err != nil {
		return *new(MetaMarketplaceBuyOffer), err
	}

	out0 := *abi.ConvertType(out[0], new(MetaMarketplaceBuyOffer)).(*MetaMarketplaceBuyOffer)
...
//
// Solidity: function getBuyOffer(address nft_contract, uint256 token_id, uint8 currency) view returns((address,uint256,uint256) b_offer)
func (_MetaMarketplace *MetaMarketplaceSession) GetBuyOffer(nft_contract common.Address, token_id *big.Int, currency uint8) (MetaMarketplaceBuyOffer, error) {
	return _MetaMarketplace.Contract.GetBuyOffer(&_MetaMarketplace.CallOpts, nft_contract, token_id, currency)
}

// GetBuyOffer is a free data retrieval call binding the contract method 0x0a3621ca.
//
// Solidity: function getBuyOffer(address nft_contract, uint256 token_id, uint8 currency) view returns((address,uint256,uint256) b_offer)
func (_MetaMarketplace *MetaMarketplaceCallerSession) GetBuyOffer(nft_contract common.Address, token_id *big.Int, currency uint8) (MetaMarketplaceBuyOffer, error) {
	return _MetaMarketplace.Contract.GetBuyOffer(&_MetaMarketplace.CallOpts, nft_contract, token_id, currency)
}

// GetFloorPriceByCurrency is a free data retrieval call binding the contract method 0x16af5a65.
//
// Solidity: function getFloorPriceByCurrency(address nft_contract, uint256 token_id, uint8 currency) view returns(uint256 floor_price)
func (_MetaMarketplace *MetaMarketplaceCaller) GetFloorPriceByCurrency(opts *bind.CallOpts, nft_contract common.Address, token_id *big.Int, currency uint8) (*big.Int, error) {
	var out []interface{}
	err := _MetaMarketplace.contract.Call(opts, &out, "getFloorPriceByCurrency", nft_contract, token_id, currency)
...
//
// Solidity: function getFloorPriceByCurrency(address nft_contract, uint256 token_id, uint8 currency) view returns(uint256 floor_price)
func (_MetaMarketplace *MetaMarketplaceSession) GetFloorPriceByCurrency(nft_contract common.Address, token_id *big.Int, currency uint8) (*big.Int, error) {
	return _MetaMarketplace.Contract.GetFloorPriceByCurrency(&_MetaMarketplace.CallOpts, nft_contract, token_id, currency)
}

// GetFloorPriceByCurrency is a free data retrieval call binding the contract method 0x16af5a65.
//
// Solidity: function getFloorPriceByCurrency(address nft_contract, uint256 token_id, uint8 currency) view returns(uint256 floor_price)
func (_MetaMarketplace *MetaMarketplaceCallerSession) GetFloorPriceByCurrency(nft_contract common.Address, token_id *big.Int, currency uint8) (*big.Int, error) {
	return _MetaMarketplace.Contract.GetFloorPriceByCurrency(&_MetaMarketplace.CallOpts, nft_contract, token_id, currency)
}
...
// GetSeller is a free data retrieval call binding the contract method 0x189ecff1.
//
// Solidity: function getSeller(address nft_contract, uint256 token_id) view returns(address seller)
func (_MetaMarketplace *MetaMarketplaceCaller) GetSeller(opts *bind.CallOpts, nft_contract common.Address, token_id *big.Int) (common.Address, error) {
	var out []interface{}
	err := _MetaMarketplace.contract.Call(opts, &out, "getSeller", nft_contract, token_id)
...
//
// Solidity: function getSeller(address nft_contract, uint256 token_id) view returns(address seller)
func (_MetaMarketplace *MetaMarketplaceSession) GetSeller(nft_contract common.Address, token_id *big.Int) (common.Address, error) {
	return _MetaMarketplace.Contract.GetSeller(&_MetaMarketplace.CallOpts, nft_contract, token_id)
}

// GetSeller is a free data retrieval call binding the contract method 0x189ecff1.
//
// Solidity: function getSeller(address nft_contract, uint256 token_id) view returns(address seller)
func (_MetaMarketplace *MetaMarketplaceCallerSession) GetSeller(nft_contract common.Address, token_id *big.Int) (common.Address, error) {
	return _MetaMarketplace.Contract.GetSeller(&_MetaMarketplace.CallOpts, nft_contract, token_id)
}
